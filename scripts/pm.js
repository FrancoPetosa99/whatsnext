class ProjectMannager{
        ...
        */
        ...
        const content = `
                ...
                <div class="card-details-container flex-around">
                    ...
                    <span class="user-icon flex-center" data-bs-toggle="tooltip" data-bs-placement="bottom" data-bs-title="Assigned to: ${task.assigned}">fp</span>
                </div>`;
    ...
    deleteTask = ()=> {
        ...
        */
        ...
        const identification = `[cardid = ${this.currentTaskID}]`;
        const taskToDelete = document.querySelectorAll('[name = a]')// document.querySelectorAll('[name = 1]');
